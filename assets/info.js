...
const ownerSignin = test_input ? testOwners[3] : useInput ? realOwner : emptyOwner
const registerLocation = test_input ? testStores[3] : useInput ? realStores[0] : emptyStore
