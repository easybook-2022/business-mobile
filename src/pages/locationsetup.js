      ...
      {setupType != "hours" ? 
        <View style={styles.box}>
          ...
          <View style={styles.inputsBox}>
            <TouchableWithoutFeedback style={{ backgroundColor: 'blue' }} onPress={() => Keyboard.dismiss()}>
                    ...
                    {logo.uri ? (
                      ...
                      <>
                        ...
                        <View style={styles.cameraActions}>
                          <TouchableOpacity style={[styles.cameraAction, { opacity: loading ? 0.3 : 1 }]} disabled={loading} onPress={snapPhoto.bind(this)}>
        ...
        :
        <>
          <ScrollView style={{ backgroundColor: '#EAEAEA', height: '90%' }}>
            <View style={styles.header}><Text style={styles.boxHeader}>Setup</Text></View>
            ...
            <View style={styles.days}>
              ...
              {!daysInfo.done ?
                ...
                :
                <View style={{ alignItems: 'center', marginBottom: 200, opacity: loading ? 0.5 : 1 }}>
...
const styles = StyleSheet.create({
  locationsetup: { backgroundColor: 'white', height: '100%', paddingTop: Platform.OS == "ios" ? 0 : Constants.statusBarHeight, width: '100%' },
  ...
  inputsContainer: { alignItems: 'center', height: '90%', width: '100%' },
  ...
  inputContainer: { marginTop: 30, width: '80%' },
  ...
  days: { alignItems: 'center', height: '80%', width: '100%' },
  ...
  daysBack: { borderRadius: 3, borderStyle: 'solid', borderWidth: 2, padding: 10 },
