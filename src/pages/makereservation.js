    ...
    getLocationHours(data)
      ...
      .then((res) => {
        if (res) {
          ...
          let openStr, closeStr, openDateStr, closeDateStr, currDateStr
          ...
          setSelecteddateinfo({
            month: currMonth, 
            year: selectedTime ? selectedTime.getFullYear() : currTime.getFullYear(),
            day: selectedTime ? selectedDay : currDay,
            date: selectedTime ? selectedDate : currDate, time: 0
          })
